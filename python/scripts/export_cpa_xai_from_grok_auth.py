...
Then any agent can use CPA:
  POST http://127.0.0.1:8317/v1/chat/completions  model=grok-4.6（当前免费档，随 xAI 调整）
"""
...
def main() -> int:
    ...
    print('  curl -sS http://127.0.0.1:8317/v1/models -H "Authorization: Bearer <CPA_KEY>" | grep grok-4')
    return 0
